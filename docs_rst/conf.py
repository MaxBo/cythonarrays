...
html_title = u'€LAN Model'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = u'€LAN'
...
latex_documents = [
  ('index', 'Elan.tex', u'Elan Documentation',
   u'Max Bohnet', 'manual'),
]
...
man_pages = [
    ('index', 'elan', u'Elan Documentation',
     [u'Max Bohnet'], 1)
]
...
texinfo_documents = [
  ('index', 'Elan', u'Elan Documentation',
   u'Max Bohnet', 'Elan', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_copyright = u'2013-2015, Max Bohnet'
